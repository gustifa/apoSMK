				...
				<p class="msg-info">Your new product has approved</p>
					...
					<div class="user-box dropdown">
						...
						<ul class="dropdown-menu dropdown-menu-end">
							<li><a class="dropdown-item" href="{{route('guru.profile')}}"><i class="bx bx-user"></i><span>Profile</span></a>
							</li>
							<li><a class="dropdown-item" href="{{route('guru.change.password')}}"><i class="bx bx-cog"></i><span>Change Password</span></a>
							</li>
							...
							<li><a class="dropdown-item" href="{{route('guru.logout')}}"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
							</li>
						</ul>
					</div>
				</nav>
